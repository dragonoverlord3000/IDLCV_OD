...
train_id, val_id  = train_test_split(split_ids_train, train_size=0.75, random_state=int(round(310701/281001 * 100496 +231002, 0))) #Random state Clara BD/Floroin BD * T BD + Hugo BD
